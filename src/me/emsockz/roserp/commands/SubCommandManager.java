...
public class SubCommandManager implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (subcommands.get(subcommand) == null) {
        	Audience aud = (sender instanceof Player) ? Main.getAdventure().player((Player)sender) : Main.getAdventure().console();
            aud.sendMessage(MessagesCFG.COMMAND_DOES_NOT_EXIST.getString());
            return true;
        }
